...
@RestController
@RequestMapping("/api/consultation-kafka")
public class ConsultationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ConsultationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ConsultationKafkaResource(KafkaProperties kafkaProperties) {
